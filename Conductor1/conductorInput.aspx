<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="conductorInput.aspx.cs" Inherits="PMPML_TIcketGhar.Conductor.conductorInput" %>
        ...
        <div class="content-container">
            <div class="form-container">
                ...
                <form id="conductor-form">
                    ...
                    <input type="text" id="prn" name="prn" placeholder="Enter PRN Number" maxlength="5">
