...
{
    public partial class conductorInput : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string connectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;Initial Catalog=PMPML_TicketGhar_DB;Integrated Security=True;Encrypt=True";
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                if (reader.Read())
                {
                    ...
                    Response.Redirect("ConductorOutput.aspx");
