...
<body>
    <form id="form1" runat="server">
      ...
      <div class="nav__logo"><img src="../UserTemplate/image/Prologo.png" style="width: 70px;"></div>
      <ul class="nav__links">
      ...
      <%--<asp:Button ID="btnContact" runat="server" CssClass="btn" Text="Contact" OnClick="btnContact_Click" />--%>
           <asp:LinkButton ID="btnExample" runat="server" CssClass="btn-link" OnClick="btnExample_Click">
    Contact
</asp:LinkButton>
    </nav>
